...
app.add_url_rule('/users/username', view_func=users.username, endpoint="users:username", methods=['POST', 'GET'])
app.add_url_rule('/users/loginUsername', view_func=users.loginUsername, endpoint="users:loginUsername", methods=['POST', 'GET'])
