...
app.add_url_rule('/posts/<post_id>/unlike', view_func=posts.remove_like, endpoint='posts:remove_like')
...
app.add_url_rule('/posts/<post_id>/comments/<comment_id>/delete', view_func=posts.delete_comment, endpoint='posts:delete_comment', methods=['POST', 'GET'])